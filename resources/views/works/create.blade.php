                    ...
                    <div class="title-block animate" data-animate="fadeInUp">
                        ...
                        <form method="POST" action="/works">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="content">{{ old('cotnent') }}</textarea>
                            ...
                            <div class="field">
                                <div class="control">
                                    <button class="btn btn-primary mb-3" type="submit">送出</button>
                                </div>
                            </div>
                        </form>
